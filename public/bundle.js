...
exports.default = function () {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_Kicks2.default, null)
    );
};
...
var _Kicks = __webpack_require__(29);

var _Kicks2 = _interopRequireDefault(_Kicks);
...
var _kicks = __webpack_require__(31);
...
function getKicks() {
    ...
    return function (dispatch) {
        _superagent2.default.get('/api/kicks').then(function (res) {
...
var _kicks = __webpack_require__(28);
...
var Kicks = function (_React$Component) {
    _inherits(Kicks, _React$Component);

    function Kicks() {
        _classCallCheck(this, Kicks);

        return _possibleConstructorReturn(this, (Kicks.__proto__ || Object.getPrototypeOf(Kicks)).apply(this, arguments));
    }

    _createClass(Kicks, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.props.dispatch((0, _kicks.getKicks)());
            console.log('I should go get kicks now');
        }
    }, {
        key: 'render',
        value: function render() {
            var kicks = this.props.kicks;
...
var mapStateToProps = function mapStateToProps(_ref) {
    var kicks = _ref.kicks;
    return {
        kicks: kicks
    };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps)(Kicks);
